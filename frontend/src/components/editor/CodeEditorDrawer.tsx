...
`;
  ...
  return (
    <div className={`code-drawer ${codeEditorOpen ? 'open' : ''}`} aria-hidden={!codeEditorOpen}>
      <div className="code-drawer-header">
        <span className="code-drawer-title">⌨ CODE EDITOR</span>
      ...
      <div className="code-drawer-body">
        ...
        <div className={`code-drawer-output ${outputType}`}>
          <div className="code-drawer-output-header">▸ OUTPUT</div>
          <div className="code-drawer-output-body">
